function [A2a,A2acrit,P,alpha] = AnDartest2(x,alpha)
...
%
%     Output:
%        A2a - anderson darling test statistic
%    A2acrit - critical A2a value for alpha confidence
